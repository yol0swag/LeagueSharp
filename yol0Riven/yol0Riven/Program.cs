    ...
    internal class Program
    {
        ...
        private static void OnGameUpdate(EventArgs args)
        {
            ...
            if (orbwalker.ActiveMode.ToString() == "Combo")
            {
                ...
                if (currentTarget != null && !currentTarget.IsValidTarget(_e.Range + _q.Range + Player.AttackRange))
                    AcquireTarget();
        ...
        private static double GetRDamage(Obj_AI_Base target) // DamageLib doesn't do this correctly yet
        {
            ...
            double minDmg = (80 + (40*(_r.Level - 1))) +
                            0.6*
                            ((0.2*(Player.BaseAttackDamage + Player.FlatPhysicalDamageMod)) +
